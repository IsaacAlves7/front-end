...
<p>When we are creating the layout of a website the browser representa each HTML element as a retangular box, this is the <b>box-model</b>. E com CSS nós alteramos a aparência dessa caixa (largura, altura, cor de fundo, etc.). Essa caixa é composta por 4 áreas: o conteúdo, o padding, a borda e a margem.</p>
<ol>
